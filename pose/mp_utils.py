...
RIGHT_LEG_MARKERS = [24, 26, 28, 30, 32]
LEFT_LEG_MARKERS = [x - 1 for x in RIGHT_LEG_MARKERS]
BOTH_ARM_MARKERS = RIGHT_ARM_MARKERS + LEFT_ARM_MARKERS
BOTH_LEG_MARKERS = RIGHT_LEG_MARKERS + LEFT_LEG_MARKERS
ALL_LIMB_MARKERS = BOTH_ARM_MARKERS + BOTH_LEG_MARKERS
LEFT_HIP = 23
RIGHT_HIP = 24
        ...
        pose_landmarks_proto.landmark.extend(
            [
                landmark_pb2.NormalizedLandmark(
                    x=pose_landmarks[i].x, y=pose_landmarks[i].y, z=pose_landmarks[i].z
                )
                for i in markers
            ]
        )
