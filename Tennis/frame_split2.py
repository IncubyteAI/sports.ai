...
for video_name in os.listdir(video_dir):
    if video_name.endswith('.mp4'):
        ...
        with open(f'/Users/tanayagrawal/PycharmProjects/sportsai/Tennis/RData/RStages-Ann/{tag}.mp4.json', 'r') as file:
            data = json.load(file)

        cap = cv2.VideoCapture(f'/Users/tanayagrawal/PycharmProjects/sportsai/Tennis/RData/RTennisServes/{tag}.mp4')
        ...
        for stage in data['tags']:
            ...
            out = cv2.VideoWriter(f'{folder_path}/{stage["name"]}_{tag}.mp4', fourcc, cap.get(cv2.CAP_PROP_FPS), (int(cap.get(3)), int(cap.get(4))))
